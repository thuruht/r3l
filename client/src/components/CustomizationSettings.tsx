...
const CustomizationSettings: React.FC = () => {
  ...
  return (
    <div style={{
      ...
      maxHeight: 'min(70vh, calc(100vh - 130px))',
      overflowY: 'auto',
      ...
      <div style={{ marginBottom: '16px' }}>
        <label style={{ display: 'block', fontSize: '12px', marginBottom: '8px', color: 'var(--text-secondary)', fontWeight: 600 }}>Interface</label>
        ...
        <button onClick={() => updateCustomization({ theme_preferences: { ...theme_preferences, backgroundUrl: null as any } })}
          disabled={!theme_preferences.backgroundUrl} style={{ width: '100%', fontSize: '0.75rem', padding: '6px' }}>
          <IconRefresh size={ICON_SIZES.sm} style={{ verticalAlign: 'middle', marginRight: '4px' }} />Reset Background
        </button>
      </div>

      <div style={{ marginBottom: '16px' }}>
        <label style={{ display: 'block', fontSize: '12px', marginBottom: '8px', color: 'var(--text-secondary)', fontWeight: 600 }}>Graph</label>
        <div style={{ marginBottom: '12px' }}>
        ...
        <div style={{ display: 'flex', gap: '8px', marginBottom: '8px' }}>
          <div style={{ flex: 1 }}>
            <label htmlFor="primary-color-input" style={{ display: 'block', fontSize: '11px', marginBottom: '4px', color: 'var(--text-secondary)' }}>Primary (Sym)</label>
          ...
          <div style={{ flex: 1 }}>
            <label htmlFor="secondary-color-input" style={{ display: 'block', fontSize: '11px', marginBottom: '4px', color: 'var(--text-secondary)' }}>Secondary (A-Sym)</label>
        ...
        <button onClick={resetColors} style={{ width: '100%', fontSize: '0.75rem', padding: '6px' }}>
          <IconRefresh size={ICON_SIZES.sm} style={{ verticalAlign: 'middle', marginRight: '4px' }} />Reset Colors
        </button>
      </div>
    </div>
  );
