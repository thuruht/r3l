...
ALTER TABLE content ADD COLUMN IF NOT EXISTS expires_at INTEGER NOT NULL DEFAULT (unixepoch() + 604800); -- 7 days
ALTER TABLE content ADD COLUMN IF NOT EXISTS archive_status TEXT DEFAULT 'active';
ALTER TABLE content ADD COLUMN IF NOT EXISTS community_archive_eligible BOOLEAN DEFAULT FALSE;
