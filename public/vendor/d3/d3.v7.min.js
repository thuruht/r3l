...
!(function (t, n) {
    ...
    function h(e) {
      ...
      function O(t) {
        if (
          ...
          (ue(t.view, g), q.on('keydown.brush keyup.brush mousemove.brush mouseup.brush', null));
  ...
  class qu {
    ...
    *neighbors(t) {
    ...
    _regioncode(t, n) {
      return (
        (t < this.xmin ? 1 : t > this.xmax ? 2 : 0) | (n < this.ymin ? 4 : n > this.ymax ? 8 : 0)
      );
    }
    _simplify(t) {
      if (t && t.length > 4) {
        ...
        (function (t) {
          ...
          for (let t = 0; t < n.length; t += 3) {
            const r = 2 * n[t],
              ...
              o = 2 * n[t + 2];
            if (
              (e[o] - e[r]) * (e[i + 1] - e[r + 1]) - (e[i] - e[r]) * (e[o + 1] - e[r + 1]) >
              1e-10
            )
              return !1;
          }
  ...
  ((Tw.prototype = ww.prototype),
    ...
    (t.geoPath = function (t, n) {
      ...
      function a(t) {
        return (
          t && ('function' == typeof o && r.pointRadius(+o.apply(this, arguments)), Lf(t, e(r))),
          r.result()
        );
      }
      return (
